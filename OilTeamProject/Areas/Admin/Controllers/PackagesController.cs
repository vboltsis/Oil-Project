...
namespace OilTeamProject.Areas.Admin.Controllers
{
    public class PackagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Material,Size,Price,Height,Length,Width")] Package package)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Material,Size,Price,Height,Length,Width")] Package package)
        {
            if (ModelState.IsValid)
            {
